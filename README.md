...
Concept DOI: [10.5281/zenodo.20533675](https://doi.org/10.5281/zenodo.20533675) | Version DOI: [10.5281/zenodo.20932039](https://zenodo.org/records/20932039) | Repository: [docxology/template_newspaper](https://github.com/docxology/template_newspaper)
...
uv run pytest --cov=newspaper          # gate: 90% branch coverage; live baseline: docs/_generated/COUNTS.md
