...
- Standalone GitHub: [docxology/template_newspaper](https://github.com/docxology/template_newspaper)
- Latest GitHub release: [v1.0.2](https://github.com/docxology/template_newspaper/releases/tag/v1.0.2)
- Zenodo concept DOI: [10.5281/zenodo.20533675](https://doi.org/10.5281/zenodo.20533675)
- Latest Zenodo version DOI: [10.5281/zenodo.20932039](https://doi.org/10.5281/zenodo.20932039) ([record](https://zenodo.org/records/20932039))
...
uv run python scripts/04_validate_output.py --project templates/template_newspaper
uv run python scripts/05_copy_outputs.py --project templates/template_newspaper
```
